...
## 6. Informe en LaTeX (Overleaf)

El informe está en `informe/informe.tex`. Para compilarlo en Overleaf:

1. Entra a https://www.overleaf.com → **New Project** → **Blank Project** (o **Upload Project**).
2. Sube el archivo `informe/informe.tex` (o pega su contenido).
3. En **Menu → Settings → Compiler** elige **pdfLaTeX**.
4. Reemplaza los campos marcados con `<...>` (nombres, profesor, universidad).
5. Sube tus capturas de pantalla y descoméntalas en las secciones `\includegraphics`.
6. Pulsa **Recompile** para generar el PDF.

---

## 7. Subir a un repositorio público (GitHub)

```bash
git init
git add .
git commit -m "Simulador de administración de memoria"
git branch -M main
git remote add origin https://github.com/TU_USUARIO/TU_REPO.git
git push -u origin main
```

> **Incluye el enlace del repositorio en el informe PDF.**

---

## 8. Checklist de entrega

- [ ] Código fuente en repositorio público (enlace en el PDF).
- [ ] Evidencia del despliegue en Docker (capturas).
- [ ] Informe PDF (compilado desde `informe/informe.tex` en Overleaf).
- [ ] Sección sobre el algoritmo **MLQ** en el informe.
- [ ] Video de máximo 5 minutos (enlace en el PDF).
- [ ] Al menos 2 archivos de entrada validados.

Consulta `GUION_VIDEO.md` para la plantilla del video.
